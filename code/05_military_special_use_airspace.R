#########################################
### 05. military special use airspace ###
#########################################
...
## layer names
data_name <- "special_use_airspace"
layer_name <- "military special use airspace"
pattern <- "SpecialUse"
...
# load data
## military special use airspace data (source: https://marinecadastre.gov/downloads/data/mc/MilitaryCollection.zip)
### metadata: https://www.fisheries.noaa.gov/inport/item/48898
data <- sf::st_read(dsn = data_dir,
                    # military special use airspace site
...
## military special use airspace geopackage
